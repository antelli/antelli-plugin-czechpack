...
abstract class BaseDialogFragment<B : ViewDataBinding, VM : BaseDialogVM> : MvvmDialogFragment<B, VM>() {
    ...
    override fun initBinding(binding: B) {
        ...
        /*binding.buttonPositive.setOnClickListener { dispatchResult(BUTTON_POSITIVE) }
        binding.buttonNegative.setOnClickListener { dispatchResult(BUTTON_NEGATIVE) }
        binding.buttonNeutral.setOnClickListener { dispatchResult(BUTTON_NEUTRAL) }
        binding.buttonCancel.setOnClickListener { dispatchResult(CANCELED) }*/
    }
